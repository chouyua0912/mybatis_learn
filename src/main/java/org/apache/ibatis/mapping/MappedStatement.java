...
public final class MappedStatement {
    ...
    private boolean flushCacheRequired;     // flushCache 	Setting this to true will cause the local and 2nd level caches to be flushed whenever this statement is called. Default: false for select statements.
